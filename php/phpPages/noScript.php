<?php
    echo "<div> 
        ...
        Per scoprire se il browser Web supporta JavaScript o per abilitare JavaScript, vedere la guida del browser Web. </p>
        <a href='../index.php'> Hai attivato JavaScript? Clicca qui </a> 
    </div>";
?>